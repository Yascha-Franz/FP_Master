...
#print(T)
#print(T/T_normal)
n_Normal_1 = unp.sqrt(1 + (n_Gas_p(1013, a_1, b_1) - 1) * T / T_normal)
n_Normal_2 = unp.sqrt(1 + (n_Gas_p(1013, a_2, b_2) - 1) * T / T_normal)
n_Normal_3 = unp.sqrt(1 + (n_Gas_p(1013, a_3, b_3) - 1) * T / T_normal)
...
print("-------------------")
print("Brechungindex bei 1013mbar und", T-273.15, "°C")
print(noms(unp.sqrt(n_Gas_p(1013, a_1, b_1))), " \pm ", std(unp.sqrt(n_Gas_p(1013, a_1, b_1))))
print(noms(unp.sqrt(n_Gas_p(1013, a_2, b_2))), " \pm ", std(unp.sqrt(n_Gas_p(1013, a_2, b_2))))
print(noms(unp.sqrt(n_Gas_p(1013, a_3, b_3))), " \pm ", std(unp.sqrt(n_Gas_p(1013, a_3, b_3))))
print("-------------------")
